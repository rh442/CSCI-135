...
int main(){
    ...
    maryash.levelUp(0);
     maryash.learnSkill(0, oop);   
     maryash.learnSkill(0, ngrams); 
     maryash.learnSkill(0, flipflop); 
      maryash.printProfemon(false);
    std::vector<Profemon> a{maryash,levitan,epstein};
    Trainer ash(a);
    cout<<ash.contains("Maryash")<<endl;
